...
\subsection{American Forests}, \textit{Director of Software and Data Engineering} \hfill \textit{40 hrs/wk, January '22}
...
- Coordinating, planning, and contributing to the maintenance of our data infrastructure\\
- Re-architecting and building our Analysis and Planning tool to scale to ten new locations in the next two years. \\
- Building our data stories and communication infrastrcture and integrating data into other communications work.
\end{addmargin}
...
\subsection{American Forests}, \textit{Senior Manager of Data Science (Software \& GeoData Engineer)} \hfill \textit{40 hrs/wk, May '20 - January '22}

\noindent 
- \textit{Tree Equity Score}
\begin{addmargin}[2em]{0em}% 1em left, 2em right
...
\subsection{Hunter College, CUNY}, \textit{Lecturer} \hfill \textit{20 hrs/wk, November '21 - Present}
...
\subsection{Graduate Cryptography} \textit{ Graduate Teaching Assistant} \hfill \textit{5 hrs/wk, January - May '20}
...
\subsection{Graduate Research Work} \textit{ Graduate Student Researcher } \hfill \textit{5 hrs/wk, August '19 - May '20}
...
\subsection{Digital Governance Lab} \textit{ Student Instructor} \hfill \textit{5 hrs/wk, August '19 - May '20}
...
\subsection{Red Hat: AI Center of Excellence} \textit{ Graduate AI Research Intern} \hfill \textit{40 hrs/wk, May - August '19}
...
\subsection{Algorithms} \textit{ Head Teaching Assistant} \hfill \textit{20 hrs/wk, January - May 2018}
...
\subsection{Red Hat: Open Innovation Labs} \textit{ Site Reliability Engineering Intern} \hfill  \textit{40 hrs/wk, May - August '18}
...
\subsection{Introduction to Computer Science} \textit{ Teaching Assistant} \hfill \textit{10 hrs/wk, January - December '17}
